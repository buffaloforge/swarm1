...
/**
 * Servlet implementation class testLdap
 */
@WebServlet("/testLdap")
public class testLdap extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String sHost = "ldap://" +"ldapin-myproject.192.168.42.200.nip.io"+":31321";
		//String sHost = "ldap://" +"localhost"+":389";
		try{		
